...
export function Step3() {
  return (
    <>
      <StepPrerequisiteWarning stepId="step3" />
      <ChecklistStep
        stepNumber={3}
        stepId="step3"
...
export function Step4() {
  return (
    <>
      <StepPrerequisiteWarning stepId="step4" />
      <ChecklistStep
        stepNumber={4}
        stepId="step4"
...
export function Step5() {
  return (
    <>
      <StepPrerequisiteWarning stepId="step5" />
      <ChecklistStep
        stepNumber={5}
        stepId="step5"
...
export function Step6() {
  return (
    <>
      <StepPrerequisiteWarning stepId="step6" />
      <ChecklistStep
        stepNumber={6}
        stepId="step6"
...
export function Step7() {
  return (
    <>
      <StepPrerequisiteWarning stepId="step7" />
      <ChecklistStep
        stepNumber={7}
        stepId="step7"
...
export function Step8() {
  return (
    <>
      <StepPrerequisiteWarning stepId="step8" />
      <ChecklistStep
        stepNumber={8}
        stepId="step8"
...
export function Step9() {
  return (
    <>
      <StepPrerequisiteWarning stepId="step9" />
      <ChecklistStep
        stepNumber={9}
        stepId="step9"
